 ...
 * <code>com.example.events.service.impl.RegistrationLocalServiceImpl</code> and
...
public class RegistrationLocalServiceUtil {
	...
	public static int getRegistrationsCount(long eventId) {
		return getService().getRegistrationsCount(eventId);
	}
